...
public class Main {
    ...
    public static void main(String[] args) {
        String message = "101001001010010101010010101001010001010101010010101010010010010101001010100101010101001010100101010101010010010010101010100100100101010110101011100100111100101010100100100101010010111101011010010101011101010001";
        int Mdest = 32;
        int Ment = 16;
